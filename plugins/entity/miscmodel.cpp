...
public:
    ...
    MiscModel(EntityClass *eclass, scene::Node &node, const Callback<void()> &transformChanged,
    ...
    MiscModel(const MiscModel &other, scene::Node &node, const Callback<void()> &transformChanged,
              const Callback<void()> &evaluateTransform) :
